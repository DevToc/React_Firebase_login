export const formConstants = {
  profileForm: {
    name: {
      ...
      value: '',
      isValid: true,
      errorText: 'Name should be between 6 and 20 characters'
    },
    oldPassword: {
      name: 'oldPassword',
      rules: [ 'MINLENGTH-8'],
    ...
    newPassword: {
      ...
      value: '',
      isValid: true,
      errorText: 'Password should contain atleast 8 characters, one capital letter and a special characters'
    },
    confirmPassword: {
  ...
  ticketForm: {
    ...
    title: {
      name: 'title',
      rules: [],
      placeholder: 'Enter a brief intro here',
      value: '',
      isValid: true,
      errorText: 'Please enter some text'
    },
